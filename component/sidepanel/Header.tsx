...
const DrawerNaviItems: IDrawerNaviItem[] = [
    ...
    {path: PanelRouterPath.RT_CHAT, name: "Live", icon:  IconSearch, activeIcon: IconSearchActive},
];
...
export default function () {
    ...
    useEffect(() => {
        ...
        } else if(location.pathname.endsWith(PanelRouterPath.SEARCH)||location.pathname.endsWith(PanelRouterPath.SEARCH_HOME)){
            setTitleImage(IconSearch);
            setTitleText(HTitle.AISearchText);
        }else{
            setTitleImage(IconSearch);
            setTitleText(HTitle.RealTimeChat); 
        }
    }, [location]);
